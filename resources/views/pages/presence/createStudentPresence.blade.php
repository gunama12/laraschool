    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ route('teacherPresence') }}">Student</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div >
                    <a class="btn btn-primary" href="{{ route('studentPresence') }}"><i class="fa fa-arrow-left"></i> Back</a>
                </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('studentPresence') }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            <!-- Task Name -->
            <div class="form-group">
                <label for="task" class="col-sm-3 control-label">Student</label>
                <div class="col-sm-6">
